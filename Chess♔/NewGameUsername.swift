...
class NewGameUsername: UIViewController, UISearchBarDelegate, UISearchDisplayDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell:NewGameUsernameTableViewCell = self.tableView.dequeueReusableCellWithIdentifier("newGameUsernameCell") as! NewGameUsernameTableViewCell
