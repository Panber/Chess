...
class Analyze: UIViewController {
    ...
    var game = PFObject(className: "Analyze")
    ...
    override func viewDidLoad() {
        ...
        let query = PFQuery(className: "Analyze")
        query.whereKey("objectId", equalTo: analyzeID)
                                                ...
                                                for var a = 0; a < yAxisArrStr2.count; a++ {
                                                    if String(moves[o][3]) == yAxisArrStr2[a] {
                                                        ...
                                                        func checkIfTakenLast() {
                                                            ...
                                                            for var w = 0; w < whitePawns.count; w++ {
                                                                if String(moves[o][1])  == "7" && String(moves[o][3]) == "8" && pieces[i].image == UIImage(named:"whitePawn") && pieces[i] == whitePawns[w]   {
                                                                    ...
                                                                    if whitePromotionType[count] == "Queen" {
                                                                        pieces[i].image = UIImage(named:"whiteQueen")
                                                                        whiteQueens += [pieces[i]]
                                                                        whitePawns.removeAtIndex(w)
                                                                        count++
                                                                    } else if whitePromotionType[count] == "Rook" {
                                                                        pieces[i].image = UIImage(named:"whiteRook")
                                                                        whiteRooks += [pieces[i]]
                                                                        whitePawns.removeAtIndex(w)
                                                                        count++
                                                                    } else  if whitePromotionType[count] == "Bishop" {
                                                                        pieces[i].image = UIImage(named:"whiteBishop")
                                                                        whiteBishops += [pieces[i]]
                                                                        whitePawns.removeAtIndex(w)
                                                                        count++
                                                                    } else  if whitePromotionType[count] == "Knight" {
                                                                        pieces[i].image = UIImage(named:"whiteKnight")
                                                                        whiteKnights += [pieces[i]]
                                                                        whitePawns.removeAtIndex(w)
                                                                        count++
                                                                    }
                                                            ...
                                                            for var w = 0; w < blackPawns.count; w++ {
                                                                if String(moves[o][1])  == "2" && String(moves[o][3]) == "1"  && pieces[i].image == UIImage(named:"blackPawn") && pieces[i] == blackPawns[w] {
                                                                    ...
                                                                    if blackPromotionType[countBlack] == "Queen" {
                                                                        pieces[i].image = UIImage(named:"blackQueen")
                                                                        blackQueens += [pieces[i]]
                                                                        blackPawns.removeAtIndex(w)
                                                                        countBlack++
                                                                    } else if blackPromotionType[countBlack] == "Rook" {
                                                                        pieces[i].image = UIImage(named:"blackRook")
                                                                        blackRooks += [pieces[i]]
                                                                        blackPawns.removeAtIndex(w)
                                                                        countBlack++
                                                                    } else if blackPromotionType[countBlack] == "Bishop" {
                                                                        pieces[i].image = UIImage(named:"blackBishop")
                                                                        blackBishops += [pieces[i]]
                                                                        blackPawns.removeAtIndex(w)
                                                                        countBlack++
                                                                    } else if blackPromotionType[countBlack] == "Knight" {
                                                                        pieces[i].image = UIImage(named:"blackKnight")
                                                                        blackKnights += [pieces[i]]
                                                                        blackPawns.removeAtIndex(w)
                                                                        countBlack++
                                                                    }
                                                                    promotionAtIndex.append(o)
                                                            ...
                                                            if  (range != nil) {
                                                                print("letters  found")
                                                                canPassant = r!["passant"] as! Bool
                                                                canPassantBlack = r!["passantBlack"] as! Bool
                                                                for var iy = 0; iy < pieces.count; iy++ {
                                                                    if  pieces[iy].frame.origin.x == xAxisArr[q] && pieces[iy].frame.origin.y == yAxisArr[a] || pieces[iy].frame.origin.x == xAxisArr[q] && pieces[iy].frame.origin.y + 1 * pieceSize == yAxisArr[a] && pieces[i].image == UIImage(named:"blackPawn") && pieces[iy].image == UIImage(named:"whitePawn") && passantArray[o] == true || pieces[iy].frame.origin.x == xAxisArr[q] && pieces[iy].frame.origin.y - 1 * pieceSize == yAxisArr[a] && pieces[i].image == UIImage(named:"whitePawn") && pieces[iy].image == UIImage(named:"blackPawn") && passantArray[o] == true   {
