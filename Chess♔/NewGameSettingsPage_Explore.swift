//
//  NewGameSettingsPage_Explore.swift
//  Chess♔
//
...
class NewGameSettingsPage_Explore: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let p = NSUserDefaults.standardUserDefaults().objectForKey("other_userImage_from_explore") as! NSData
        userProfilePic.image = UIImage(data: p)
        
        useruserName.text = NSUserDefaults.standardUserDefaults().objectForKey("other_username_from_explore") as? String
        
        userRating.text = String(NSUserDefaults.standardUserDefaults().objectForKey("other_userrating_from_explore")!)
