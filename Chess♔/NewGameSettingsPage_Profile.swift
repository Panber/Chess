//
//  NewGameSettingsPage_Profile.swift
//  Chess♔
//
...
class NewGameSettingsPage_Profile: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let p = NSUserDefaults.standardUserDefaults().objectForKey("other_userImage_from_profile") as! NSData
        userProfilePic.image = UIImage(data: p)
        
        useruserName.text = NSUserDefaults.standardUserDefaults().objectForKey("other_username_from_profile") as? String
        
        userRating.text = String(NSUserDefaults.standardUserDefaults().objectForKey("other_userrating_from_profile")!)
