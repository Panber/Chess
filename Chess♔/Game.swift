                                                                ...
                                                                func checkIfTakenLast() {
                                                                    ...
                                                                    if  (range != nil) {
                                                                        ...
                                                                        for var iy = 0; iy < pieces.count; iy++ {
                                                                            if  self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y == yAxisArr[a] || self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y - 1 * pieceSize == yAxisArr[a] && canSaveKing(self.pieces[iy], array: self.blackPawns) && self.canPassant == true && self.pieces[i].image == UIImage(named:"whitePawn") || self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y + 1 * pieceSize == yAxisArr[a] && canSaveKing(self.pieces[iy], array: self.whitePawns) && self.canPassantBlack == true && self.pieces[i].image == UIImage(named:"blackPawn") {
                                                                ...
                                                                func checkIfTaken() {
                                                                    ...
                                                                    if  (range != nil) {
                                                                        ...
                                                                        for var iy = 0; iy < pieces.count ; iy++ {
                                                                            ...
                                                                            if  self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y == yAxisArr[a] || self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y - 1 * pieceSize == yAxisArr[a] && canSaveKing(self.pieces[iy], array: self.blackPawns) && self.pieces[i].image == UIImage(named:"whitePawn") || self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y + 1 * pieceSize == yAxisArr[a] && canSaveKing(self.pieces[iy], array: self.whitePawns) && self.pieces[i].image == UIImage(named:"blackPawn") {
                                                                    ...
                                                                    UIView.animateWithDuration(0.8, delay: 0.5, options: .CurveEaseInOut, animations:{ () -> Void in
                                                                        ...
                                                                        self.pieceBlackLogicOptions = []
                                                                            ...
                                                                            if self.checkByQueen == true || self.checkByBishop == true || self.checkByRook == true || self.checkByKnight == true || self.checkByPawn == true {
                                                                                ...
                                                                                if self.whiteBishops.count == 0 {
                                                                                    checkMate2 = true
                                                                                }
                                                                                if self.whiteRooks.count == 0 {
                                                                                    checkMate3 = true
                                                                                }
                                                                                if self.whiteQueens.count == 0 {
                                                                                    checkMate4 = true
                                                                                }
                                                            ...
                                                            if String(moves[o][3]) == yAxisArrStr2[a] {
                                                                ...
                                                                func checkIfTakenLast() {
                                                                    ...
                                                                    if  (range != nil) {
                                                                        ...
                                                                        self.canPassantBlack = r!["passantBlack"] as! Bool
                                                                        for var iy = 0; iy < pieces.count; iy++ {
                                                                            if  self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y == yAxisArr[a] || self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y - 1 * pieceSize == yAxisArr[a] && canSaveKing(self.pieces[iy], array: self.blackPawns) && self.canPassantBlack == true && self.pieces[i].image == UIImage(named:"blackPawn") || self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y + 1 * pieceSize == yAxisArr[a] && canSaveKing(self.pieces[iy], array: self.whitePawns) && self.canPassant == true  && self.pieces[i].image == UIImage(named:"whitePawn"){
                                                                ...
                                                                func checkIfTaken() {
                                                                    ...
                                                                    if  (range != nil) {
                                                                        ...
                                                                        for var iy = 0; iy < pieces.count; iy++ {
                                                                            ...
                                                                            if  self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y == yAxisArr[a] || self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y - 1 * pieceSize == yAxisArr[a] && canSaveKing(self.pieces[iy], array: self.blackPawns) || self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[i].image == UIImage(named:"blackPawn") && self.pieces[iy].frame.origin.y + 1 * pieceSize == yAxisArr[a] && canSaveKing(self.pieces[iy], array: self.whitePawns) && self.pieces[i].image == UIImage(named:"whitePawn") {
                                                                ...
                                                                func checkIfTakenLast() {
                                                                    ...
                                                                    if  (range != nil) {
                                                                        ...
                                                                        for var iy = 0; iy < self.pieces.count; iy++ {
                                                                             if  self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y == yAxisArr[a] || self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y - 1 * pieceSize == yAxisArr[a] && self.canSaveKing(self.pieces[iy], array: self.blackPawns) && self.canPassantBlack == true && self.pieces[i].image == UIImage(named:"blackPawn") || self.pieces[iy].frame.origin.x == xAxisArr[q] && self.pieces[iy].frame.origin.y + 1 * pieceSize == yAxisArr[a] && self.canSaveKing(self.pieces[iy], array: self.whitePawns) && self.canPassant == true && self.pieces[i].image == UIImage(named:"whitePawn") {
        ...
        if timerNumber > 10 {
            ...
            if self.colorLcolor == "You are Black" {
                if self.checkByQueen == true || self.checkByBishop == true || self.checkByRook == true || self.checkByKnight == true || self.checkByPawn == true {
                    ...
                    if blackBishops.count == 0 {
                        checkMate2 = true
                    }
                    if blackRooks.count == 0 {
                        checkMate3 = true
                    }
                    if blackQueens.count == 0 {
                        checkMate4 = true
                    }
